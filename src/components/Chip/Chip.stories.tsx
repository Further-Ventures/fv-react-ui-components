...
interface IStoryArgs extends IChip {icon?: string}
        ...
        return variants.map(variant => {
          return (
            <>
              ...
              <Chip variant={variant} label={`${variant} disabled`} size={size} disabled contentRight={<Icon icon='check_circle' size={iconSize} />}/>
            </>
          );
        })
      })}
