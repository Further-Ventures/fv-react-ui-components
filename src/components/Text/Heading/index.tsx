  ...
  return (
    <Component
      className={classNames('mt-0 pt-0', {
          ...
          ['text-xl leading-normal mb-5 lg:font-mercury-alt lg:text-5xl lg:leading-snug lg:uppercase']: tag === 'h2',
          ['text-lg leading-normal mb-3 lg:font-mercury-alt lg:text-4xl lg:leading-tight lg:uppercase']: tag === 'h3',
          ['text-lg leading-normal mb-3 lg:text-2xl lg:leading-tight lg:mb-4']: tag === 'h4',
          ['text-lg leading-normal mb-3 lg:text-2xl lg:leading-normal lg:font-normal lg:mb-4']: tag === 'h5',
